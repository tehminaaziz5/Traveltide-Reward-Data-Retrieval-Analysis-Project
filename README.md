...
Identify factors influencing booking and cancellation behavior

Analyze the role of discounts, trip distance, duration, and cost

Aggregate session data into meaningful user-level profiles
...
Feature engineering (engagement, booking, trip, and cost features)

Exploratory Data Analysis (EDA) of sessions
...
Analysis of engagement intensity, booking rates, discount sensitivity, and customer value
...
Booking type and booking status

Trip start/end, duration, distance, and category

Discount usage and discount amount

Base trip cost and total trip cost
...
Discount users show greater variability and higher price sensitivity

Discounts play a supporting role rather than being the primary driver of bookings

A small group of users contributes disproportionately to overall value
...
traveltide_01_sessions_eda.ipynb – Session-level exploration and feature enrichment
